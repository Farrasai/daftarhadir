                ...
                ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <button class="btn btn-warning btn-sm text-white" data-toggle="modal" data-target="#modalUbahKegiatan" data-id="<?= $row->id ?>" data-judul="<?= $row->judul ?>" data-nama_kegiatan="<?= $row->nama_kegiatan ?>" data-slug="<?= $row->slug ?>" data-narasumber="<?= $row->narasumber ?>" data-tanggal="<?= $row->tanggal ?>" data-publish="<?= $row->status_page ?>" id="btn-edit"><i class="fas fa-edit"></i> Ubah</button>
